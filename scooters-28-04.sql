...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2024 at 10:36 PM
...
CREATE TABLE `reservations` (
  ...
  `status` enum('new','accepted','refused','ended','confirmed') NOT NULL DEFAULT 'new',
  `scooter_id` int(10) NOT NULL,
  `customer_id` int(10) NOT NULL,
...
(5, 'اسكوتر حديث', 'واقف', '2016', 'ازرق', 'بينيلي', 'uploads/scooters/3427751442.jpg', 15, 'اسكوتر جديد بحالة ممتازة يتميز بالسرعة', '0', 0),

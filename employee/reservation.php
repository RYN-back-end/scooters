    ...
    <section class="tableSection">
        ...
        <div class="tableDiv">
            ...
            if ($row['status'] == 'confirmed') {
                $status = '<button class="success" type="button"><a style="color: green" class="confirmation" href="?method=UPDATE&status=accepted&reservation_id=' . $row['reservation_id'] . '">قبول الحجز</a></button>';
                $status .= '<button class="danger" type="button"><a style="color: red" class="confirmation" href="?method=UPDATE&status=refused&reservation_id=' . $row['reservation_id'] . '">رفض الحجز</a></button>';
            } elseif ($row['status'] == 'accepted') {
                $status = '<button class="success" type="button"><a style="color: white" class="confirmation" href="?method=UPDATE&status=handed&reservation_id=' . $row['reservation_id'] . '">تم تسليم الاسكوتر</a></button>';
            } elseif ($row['status'] == 'handed') {
                $status = '<button class="success" type="button"><a style="color: white" class="confirmation" href="?method=UPDATE&status=received&reservation_id=' . $row['reservation_id'] . '">تم استلام الاسكوتر</a></button>';
            } elseif ($row['status'] == 'received') {
                $status = '<button class="success" type="button"><a style="color: white" class="confirmation" href="?method=UPDATE&status=ended&reservation_id=' . $row['reservation_id'] . '">انهاء الحجز</a></button>';

...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2024 at 12:39 AM
...
(1, 'رهف محمد', 'rahaf@gmail.com', '+966552255', 'تأجير الاسكوتر الاحمر', 'هل يمكن التأجير لفترات كبيرة', '2024-04-19', 1, '');
...
(2, 'سحر صلاح', 'soso@gmail.com', '$2y$10$LcF5zM2MqiSjeXy7hm7rkut062aMEHjU.Z6tIKZjnL4l0JPZTtnY2', 'لاىةو', 'المدينة');
...
(2, 'اسكوتر 2', 'واقف', '2011', 'اسود', 'بينيلي', 'uploads/scooters/3425917520.jpg', 10, 'اسكوتر جديد بحالة ممتازة', ''),
(4, 'اسكوتر جديد', 'هوجان', '2016', 'احمر', 'بينيلي', 'uploads/scooters/3427074442.jpg', 12, 'اسكوتر جديد بحالة ممتازة يتميز بالسرعة', ''),
(5, 'اسكوتر حديث', 'واقف', '2016', 'ازرق', 'بينيلي', 'uploads/scooters/3427075016.jpg', 15, 'اسكوتر جديد بحالة ممتازة يتميز بالسرعة', '');
...
--
ALTER TABLE `questions`
  MODIFY `question_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `scooter`
  MODIFY `scooter_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
